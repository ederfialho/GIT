<%@ page language="java" import= "java.sql.*, controle.ConnectionFactoryOld;"%>
...
try {
Connection con = ConnectionFactoryOld.getConnection();
...
%>
<body>
<form id="relacesso" name="relacesso" method="post" action="Relatorio">
<p>Tipo de Colaborador (+).:
<input name="tipocola" type="text" maxlength="5" class="inputcampos" id="tipocola" onmouseover="exibirmensagem('1 - Colaborador; 2 - Terceiro; 3 - Parceiro. Para escolher mais de 1 Tipo de Colaborador, use vírgula após o número. ')" onmouseout="exibirmensagem('')"/><div id="msg"></div> 
